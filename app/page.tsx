      ...
      <div className="min-h-screen flex items-center justify-center bg-black text-white fixed inset-0 z-50">
        <div className="text-center">
          <h1 className="font-semibold mb-4">
            ...
            <span className="font-sans text-4xl sm:text-2xl md:text-4xl"> {staticText}</span>
            <span className="font-sans text-4xl sm:text-2xl md:text-4xl inline-block w-48 sm:w-80 md:w-96 text-left">
              {displayText}
